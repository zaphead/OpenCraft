...
3. If macOS says the app is **damaged** or won't open, remove the download quarantine flag (this is normal for unsigned builds since iowanna pay the 100 dolla apple tax.):
